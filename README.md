...
Main language of this project is Russian, but it's repositories is on semi-language support what means that you can read all of main information.

Our language politics doesn't restrict other languages, but we recommend that you speak on Russian, because when using foreign languages (in relation to the project), you may not be understood.
